...
const IndexView = () => (
  <ViewLayout>
    ...
    {/* <Offline polling={{ enabled: true, interval: 500 }}>
      <a href="/downloads">Go to My Downloads</a>
      ...
      {/* <Card> */}
        {/* <CardImg top width="100%" src="../assets/profile_icon.png" alt="Card image cap" /> */}
        {/* <CardBody> */}
          {/* <CardTitle><h1 style={{textAlign:"center"}}>Progressive Web App is the future of Web Developemnt</h1></CardTitle> */}
	...
	<div class="prs_main_slider_wrapper">
		<div id="rev_slider_41_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="food-carousel26" data-source="gallery" style={{margin:"0px auto",padding:"0px",marginTop:"0px", marginBottom:"0px"}}>
